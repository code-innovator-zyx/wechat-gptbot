...
- 唤醒：无需特殊唤醒词，只需要正常询问即可，会通过语义判断是否执行插件
  ![天气.png](docs/天气.png)
  ![新闻.png](docs/新闻.png)

### 时间: 2024年 6月19日

- 功能描述：增加每日早晨天气、热点消息及微信装逼神器的自动触达功能
- ![img.png](docs/cron1.png)
- 可自定义修改触发时间: 可自定义触达时间，修改 cron.json 中的 cron 表达式即可
- 对于不会开发的人员，有可视化操作，可以通过自然语言设置执行时间
- ![img.png](docs/cron2.png)

- 可定制化插件: 可以自定义插件，在目录`core/plugins`目录下根据模版实现几个接口注册进插件管理器就行了
